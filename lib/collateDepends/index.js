...
const collateDepends = packageJson => {
  const collated = [..._get__("createDepsList")(packageJson.dependencies), ..._get__("createDepsList")(packageJson.devDependencies)];
  return collated;
};

exports.default = _get__("collateDepends");
...
function _get_original__(variableName) {
  switch (variableName) {
    case "createDepsList":
      return createDepsList;

    case "collateDepends":
      return collateDepends;
  }
...
let _typeOfOriginalExport = typeof collateDepends;

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(collateDepends, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(collateDepends)) {
