...
const walker = (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* (task, cb) {
    ...
    let regDeps;
    try {
      regDeps = yield (0, _registryDeps2.default)(task.dependency);
    } catch (err) {
...
const walkDeps = (() => {
  var _ref2 = (0, _asyncToGenerator3.default)(function* (moduleToFind, dependsFile = 'package.json', done) {
    const packageJsonDeps = yield (0, _fileDeps2.default)(dependsFile);
