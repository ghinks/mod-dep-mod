...
var walkDeps = function () {
  var _ref3 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(moduleToFind) {
    var dependsFile = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'package.json';
    ...
    return _regenerator2.default.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0, _fileDeps2.default)(dependsFile);
