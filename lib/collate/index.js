...
var collateDepends = function collateDepends(packageJson) {
  var collated = [].concat((0, _toConsumableArray3.default)(_get__("createDepsList")(packageJson.dependencies)), (0, _toConsumableArray3.default)(_get__("createDepsList")(packageJson.devDependencies)));
  return collated;
};
...
var _typeOfOriginalExport = typeof collateDepends;
