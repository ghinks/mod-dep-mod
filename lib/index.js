...
_get__('program').version('1.0.0').option('-m, --module [value]', 'find root module that requires this module').parse(process.argv);
...
const getDependencyTree = (() => {
  var _ref = (0, _asyncToGenerator3.default)(function* () {
    let depends = yield _get__('getDepends')('package.json');
    _get__('collate')(depends).forEach(function (d) {
      return console.log(_get__('treeify').asTree(d, true));
    });
    depends = yield _get__('registryDeps')();
  });
