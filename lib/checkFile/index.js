...
const debugFile = _get__('debug')('file');

const checkForFile = file => {
  _get__('debugFile')(`check for file ${file}`);
  return _get__('fs').existsSync(file);
};

exports.default = _get__('checkForFile');
...
let _typeOfOriginalExport = typeof checkForFile;

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(checkForFile, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(checkForFile)) {
