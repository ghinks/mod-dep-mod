...
var cleanPrivateProps = function cleanPrivateProps(obj) {
  ...
  (0, _keys2.default)(obj).forEach(function (k) {
    if (obj[k] instanceof Object) _get__("cleanPrivateProps")(obj[k]);
  });
  return obj;
};

exports.default = _get__("cleanPrivateProps");
...
function _get_original__(variableName) {
  switch (variableName) {
    case "cleanPrivateProps":
      return cleanPrivateProps;
  }
...
var _typeOfOriginalExport = typeof cleanPrivateProps;

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(cleanPrivateProps, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(cleanPrivateProps)) {
