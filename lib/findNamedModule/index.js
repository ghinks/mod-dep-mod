...
var findNamedModule = function findNamedModule(obj, name, tree) {
  ...
  (0, _keys2.default)(obj).filter(function (k) {
    ...
    matchingKeys = [].concat((0, _toConsumableArray3.default)(matchingKeys), (0, _toConsumableArray3.default)(_get__('findNamedModule')(obj[k], name, `${tree ? tree + '.' + k : k}`)));
  });
  return matchingKeys;
};

exports.default = _get__('findNamedModule');
...
var _typeOfOriginalExport = typeof findNamedModule;

function addNonEnumerableProperty(name, value) {
  (0, _defineProperty2.default)(findNamedModule, name, {
    value: value,
    enumerable: false,
    configurable: true
  });
...
if ((_typeOfOriginalExport === 'object' || _typeOfOriginalExport === 'function') && (0, _isExtensible2.default)(findNamedModule)) {
